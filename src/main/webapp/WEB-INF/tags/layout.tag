        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-8">
                    <h1 class="text-2xl font-black tracking-tight text-red-600 cursor-pointer" onclick="location.href='${root}/movie'">
                        CINEFLIX
                    </h1>

                    <nav class="hidden md:flex items-center gap-6">
                        <a href="${root}/movie" class="text-white hover:text-red-500 transition-colors font-medium">Home</a>
                        <a href="#" class="text-white/60 hover:text-white transition-colors text-sm">Movies</a>
                        <a href="#" class="text-white/60 hover:text-white transition-colors text-sm">TV Shows</a>
                        <a href="${root}/my-lists" class="text-white/60 hover:text-white transition-colors text-sm">My Lists</a>
                    </nav>
                </div>
                ...
                <div class="flex items-center gap-6">
                    <div class="relative flex items-center" id="searchWrapper">
                        ...
                        <div id="searchBarContainer" class="hidden items-center bg-black/60 border border-white/20 rounded-full px-4 py-1.5 transition-all duration-300 animate-fade-in">
                        ...
                        <%-- The Trigger Icon --%>
                        <button id="searchBtn" class="text-white/80 hover:text-white transition-colors p-2">
                            <i data-lucide="search" class="w-6 h-6"></i>
                        </button>

                        <%-- Advanced Results Dropdown --%>
                        <div id="searchResults" class="hidden absolute top-14 right-0 w-80 md:w-96 bg-[#141414] border border-white/10 rounded-xl overflow-hidden z-[100] search-dropdown-shadow animate-fade-in">
                            <div id="emptyState" class="p-10 flex flex-col items-center justify-center text-center">
                                ...
                                <p class="text-white text-sm font-medium">Start typing to search movies</p>
                            </div>
                    ...
                    <button class="w-8 h-8 rounded-md bg-red-600 flex items-center justify-center">
